...
IVOAI_LIVE_OPENCODE_TUI=1 \
  go test ./internal/opencodebridge ./internal/agents \
    -run 'TestLive(ManagedOpenCode(RoutesPromptThroughIVOAI|AttachRendersIVOAIPlugin|Permissions|API|ResizeKeyboard)|OpenCodeExecutor(HTTPContract|NativeLifecycle))$' \
    -count=1 -v
