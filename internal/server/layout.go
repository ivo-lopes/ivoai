...
func DefaultLayout(root string) Layout {
	...
	return Layout{
		...
		QdrantDir: filepath.Join(data, "qdrant"), ModelsDir: filepath.Join(data, "models"), BackupDir: filepath.Join(data, "backups"),
		RuntimeDir: join("/run/ivoai"), InstallDir: join("/opt/ivoai"), SystemdDir: join("/etc/systemd/system"),
	}
}

func (l Layout) Validate() error {
	dirs := []string{l.ConfigDir, l.SecretsDir, l.DataDir, l.ContextDir, l.CorpusDir, l.MemoryDir, l.QdrantDir, l.ModelsDir, l.BackupDir, l.RuntimeDir, l.InstallDir, l.SystemdDir}
...
func (l Layout) Ensure() error {
	...
	private := []string{l.ConfigDir, l.SecretsDir, filepath.Join(l.SecretsDir, "tls"), l.DataDir, l.ContextDir, l.CorpusDir, l.MemoryDir, l.QdrantDir, l.ModelsDir, l.BackupDir, l.RuntimeDir, l.InstallDir}
