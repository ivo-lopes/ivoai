...
var sensitivePatterns = []*regexp.Regexp{
	...
	regexp.MustCompile(`(?i)((?:api[_-]?key|secret[_-]?key|access[_-]?token|refresh[_-]?token|oauth[_-]?token|id[_-]?token|client[_-]?secret|enrollment[_-]?code)\s*[=:]\s*)[^\s,;]+`),
	regexp.MustCompile(`(?i)\b(?:sk-[A-Za-z0-9_-]{12,}|ivo_[A-Za-z0-9_-]{12,}|ivoai-(?:client|enroll)_[A-Za-z0-9_-]{12,})\b`),
	regexp.MustCompile(`\bplane_api_[A-Za-z0-9_-]+\b`),
}
