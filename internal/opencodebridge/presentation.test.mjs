...
const states = {
 full_console:{...normal,automation_profile:"quality",hook_health:{codex:"healthy","claude-code":"degraded"},console:{schema:1,sequence:3,checkpoint:true,tasks:[{id:"task-b",state:"running",dependencies:["task-a"],worktree:true,integrated:false,mcp_tools:{plane:["read_tool"]}}],events:[{sequence:3,operation:"worker.lifecycle",state:"running",task_id:"task-b"}]}},
