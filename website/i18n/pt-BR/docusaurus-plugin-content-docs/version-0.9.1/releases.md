...
O patch estável `v0.9.1` preserva a arquitetura OpenCode-first enquanto restaura
...
saída parcial, unifica o canvas da documentação e adiciona locales completos em
inglês e português do Brasil. As notas completas estão em
